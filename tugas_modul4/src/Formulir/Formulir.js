...
const anecdotes = [
    '','Merah', 'Jingga','Kuning', 'Hijau', 'Biru', 'Nila', 'Ungu', 'Cyan', 'Maroon'
]
    ...
    return (
        ...
        <div className="contentWrapper" style={{ backgroundColor: valueTheme.background }}>
          <div className="container">
            <button className= "Button" style={{ backgroundColor: valueTheme.button }}
              onClick={() =>
                setValueTheme(
                  valueTheme === themes.red ? themes.brown : themes.red
                )
              }
            >Theme</button>        
            <center>
              ...
              <div className="inputWrapper">
                ...
                <div>
                  <input
                    ...
                    onChange={(event) => inputHandler(event, "number")}
                  />
                </div>
                <br></br>
                <p className="nama" style={{ color: valueTheme.button }}>Hai {valueInput.name}</p>
                <p>Tekan tombol dibawah untuk menampilkan warna keberuntunganmu: <h4>{anecdotes[selected]}</h4></p>
